...
public interface UserEventService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.amf.user.events.service.impl.UserEventServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user event remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserEventServiceUtil} if injection and service tracking are not available.
	 */
	public UserEvent addUserEvent(
